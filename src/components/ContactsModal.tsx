          ...
          {contacts.map(contact => (
            <div key={contact.id} className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors group">
              ...
              <div className="flex items-center gap-1 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity">
                <a href={'tel:' + contact.phone} target="_top" className="p-2 rounded-full hover:bg-green-500/20 text-green-400 transition-colors" title="Call">
                  <Phone size={16} />
                </a>
                <a href={'whatsapp://send?phone=' + contact.phone} target="_top" className="p-2 rounded-full hover:bg-blue-500/20 text-blue-400 transition-colors" title="Message">
